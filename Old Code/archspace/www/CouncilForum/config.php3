<?php
// added by thedaz
$as_url = "http://archspace.archmage.co.kr";
...
$url_phpbb = "http://archspace.archmage.co.kr/CouncilForum"; 
...
// set this value to 
// $cookiedomain = "bar.com";
$cookiedomain = "archmage.co.kr";
...
$folder_image = "http://board.archmage.co.kr/ASubbKR/closed.gif";
$hot_folder_image = "$url_images/hot_folder.gif";
//$hot_folder_image = "http://board.archmage.co.kr/ASubbKR/hotclosed.gif";
//$newposts_image = "$url_images/red_folder.gif";
$newposts_image = "http://board.archmage.co.kr/ASubbKR/closedb.gif";
//$hot_newposts_image = "$url_images/hot_red_folder.gif";
$hot_newposts_image = "http://board.archmage.co.kr/ASubbKR/hotclosedb.gif";
...
/* -- Added Images -- */
$FORUM_TITLE_IMAGE = "http://board.archmage.co.kr/ASubbKR/images/forum_title.gif";
$NEW_TOPIC_IMAGE = "http://board.archmage.co.kr/ASubbKR/images/newtopic.gif";
$SEARCH_IMAGE = "http://board.archmage.co.kr/ASubbKR/images/search.gif";
$REPLY_IMAGE = "http://board.archmage.co.kr/ASubbKR/images/reply.gif";
$GO_IMAGE = "http://board.archmage.co.kr/ASubbKR/images/go.gif";
?>
