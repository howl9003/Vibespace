...
/***************************************************************************
    ...
    $Id: page_header.php,v 1.69 2001/02/07 00:13:36 thefinn Exp $ 
...
<TR>                    
        <TD ALIGN="CENTER" WIDTH="50%" ROWSPAN="2"><a href="<?php echo $url_phpbb?>/index.<?php echo $phpEx ?>"><IMG SRC="<?php echo $header_image?>" border="0"></a></TD>
<?php
...
<?php		
		if ($user_logged_in)
		{
			...
			$sql = "SELECT count(*) AS count
			      ...
			      WHERE p.to_userid = u.user_id and p.msg_status = '0' and u.username = '$userdata[username]'";
