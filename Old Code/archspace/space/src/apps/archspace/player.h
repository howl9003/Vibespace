...
class CPlayer: public CStore
{
	...
	private:
		...
		int mPopulationIncreased;	//telecard 2001/04/02
		int	mHonor;
		...
		CDefensePlanList mDefensePlanList;		/* telecard 2000/10/25 */
	...
	public: // get
		...
		CComponentList *get_component_list() { return &mComponentList; }
		...
		CProjectList *get_project_list() { return &mProjectList; }
		...
		CTechList *get_available_tech_list() { return &mAvailableTechList; }
	...
	public: // etc
		...
		bool can_buy_any_project();
		bool buy_project(int aProject, bool aPayPrice = true);
		void buy_secret_project(int aProject);	//telecard 2001/03/14
		...
		inline bool is_available_project(int aProjectID);
		void save_planet();
		...
		inline void add_action(CPlayerAction* aAction);
		inline void remove_action(int aActionID);

		inline void add_relation(CPlayerRelation* aRelation);
		inline void remove_relation_all();
		inline void remove_relation(int aRelationID);
		inline void remove_relation_by_target_id(int aTargetID);

		inline void add_diplomatic_message(CDiplomaticMessage* aMessage);
		inline CDiplomaticMessage* get_diplomatic_message(int aMessageID);
		inline void remove_diplomatic_message(int aMessageID);
	...
	public:
		...
		inline CPlayer *prev(CPlayer* aPlayer=NULL);
		inline CPlayer *next(CPlayer* aPlayer=NULL);
