...
#define INTERVAL_DEBUG			60*15		// second
#define INTERVAL_PUSH				30			
#define INTERVAL_COUNCIL			96		// turns
#define INTERVAL_OPTIMIZE			24*60*60
#define INTERVAL_ACTION				15			
#define INTERVAL_RELATION_TIMEOUT	35			
#define INTERVAL_RANK				60*60	// second
#define INTERVAL_CRONTAB		60
#define INTERVAL_EMPIRE_COUNTERATTACK_MAGISTRATE		60*60	// second
#define INTERVAL_EMPIRE_COUNTERATTACK_EMPIRE_PLANET		30*60	// second

#define INTERVAL_PERSONAL_ENDING	60*60*24	// 1day
...
/**
*/
class CTriggerDatabasePush: public CTrigger
{
	public:
		virtual ~CTriggerDatabasePush() {}

		virtual const char *name() { return "database push"; }
	protected:
		virtual time_t interval() { return INTERVAL_PUSH; }
		virtual bool handler();
};
...
class CTriggerPersonalEnding: public CTrigger
{
	public:
		virtual ~CTriggerPersonalEnding() {};
		virtual const char *name() { return "perosnal_ending"; }
	protected:
		virtual time_t interval() { return INTERVAL_PERSONAL_ENDING; }
		virtual bool handler();
};
