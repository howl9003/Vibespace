...
class CProject: public CBase
{
	...
	public:		// set
		...
		inline void set_prerequisite(int aPrerequisite);
		...
		bool set_race(int aRace);
		void set_race_all();

		bool add_effect(CPlayerEffect *aEffect);

	public:		// etc
		bool is_for_race(int aRace);
...
inline void
CProject::set_prerequisite(int aPrerequisite) 
{ 
