...
CDefensePlanList::special_defense_plan_info_html()
{
	...
	PlanInfo.format("<INPUT TYPE=image SRC=\"http://%s/image/as_game/bu_change.gif\" WIDTH=\"67\" HEIGHT=\"11\" BORDER=\"0\" onClick=\"document.SPECIAL.PLAN_BUTTON.value=\'CHANGE\'\">",
					(char *)CGame::mImageServerURL);
	PlanInfo += "&nbsp;&nbsp;";
	PlanInfo.format("<INPUT TYPE=image SRC=\"http://%s/image/as_game/bu_delete.gif\" WIDTH=\"57\" HEIGHT=\"11\" BORDER=\"0\" onClick=\"document.SPECIAL.PLAN_BUTTON.value=\'DELETE\'\">",
					(char *)CGame::mImageServerURL);
	PlanInfo += "</TD>\n";
