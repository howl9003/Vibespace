...
//	SLOG("PlanetNewCenter mPlanet:%x", (int)mPlanet);
	...
	if (Factory)
	{
		...
		if (Factory < 0)
		{
			if (Factory == -1)
			{
				Buffer.format(GETTEXT("1 factory has been destroyed.(%1$s unit(s) now)"),
								(char *)New);
			}
			else
			{
				Buffer.format(GETTEXT("%1$s factories have been destroyed.(%2$s unit(s) now)"),
								(char *)Diff, (char *)New);
			}
		}
		else 
		{
			if (Factory == 1)
			{
				Buffer.format(GETTEXT("1 factory has been built.(%1$s unit(s) now)"),
								(char *)New);
			}
			else
			{
				Buffer.format(GETTEXT("%1$s factories have been built.(%2$s unit(s) now)"),
								(char *)Diff, (char *)New);
			}
		}
		Buffer += "<BR>\n";
	...
	if (MilitaryBase)
	{
		...
		if (MilitaryBase < 0)
		{
			if (MilitaryBase == -1)
			{
				Buffer.format(GETTEXT("1 military base has been destroyed.(%1$s unit(s) now)"),
								(char *)New);
			}
			else
			{
				Buffer.format(GETTEXT("%1$s military bases have been destroyed.(%2$s unit(s) now)"),
								(char *)Diff, (char *)New);
			}
		}
		else 
		{
			if (MilitaryBase == 1)
			{
				Buffer.format(GETTEXT("1 military base has been built.(%1$s unit(s) now)"),
								(char *)New);
			}
			else
			{
				Buffer.format(GETTEXT("%1$s military bases have been built.(%2$s unit(s) now)"),
								(char *)Diff, (char *)New);
			}
		}
		Buffer += "<BR>\n";
	...
	if (ResearchLab)
	{
		...
		if (ResearchLab < 0)
		{
			if (ResearchLab == -1)
			{
				Buffer.format(GETTEXT("1 research lab. has been destroyed.(%1$s unit(s) now)"),
								(char *)New);
			}
			else
			{
				Buffer.format(GETTEXT("%1$s research labs. have been destroyed.(%2$s unit(s) now)"),
								(char *)Diff, (char *)New);
			}
		}
		else 
		{
			if (ResearchLab == 1)
			{
				Buffer.format(GETTEXT("1 research lab. has been built.(%1$s unit(s) now)"),
								(char *)New);
			}
			else
			{
				Buffer.format(GETTEXT("%1$s research labs. have been built.(%2$s unit(s) now)"),
								(char *)Diff, (char *)New);
			}
		}
		Buffer += "<BR>\n";
