...
class CDiplomaticMessage: public CStore
{
	...
	public:
		inline int get_id();
		inline CPlayer* get_sender();
		inline CPlayer* get_receiver();
		inline time_t get_time();
		char *get_content();
		inline EType get_type();
		const char* get_time_string();
		bool check_need_required();
		static bool check_need_required(int aMessageType);

		inline const char* get_type_description();
		static const char* get_type_description(EType aType);
		inline const char* get_status_description();
		static const char* get_status_description(EStatus aStatus);
		inline EStatus get_status();

		inline void set_status(EStatus aStatus);
...
class CCouncilMessage: public CStore
{
	...
	public:
		inline int get_id();
		inline CCouncil* get_sender();
		inline CCouncil* get_receiver();
		inline time_t get_time();
		char *get_content();
		inline EType get_type();
		const char* get_time_string();
