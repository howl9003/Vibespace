...
CMission::get_mission_name(CMission::EMissionType aMission)
{
	switch(aMission)
	{
		...
		case MISSION_DISPATCH_TO_ALLY: 
			return GETTEXT("Dispatch to Ally");
...
CMission::set_mission(CMission::EMissionType aMission)
{
	...
	{
		case MISSION_TRAIN:
			mTerminateTime = CGame::get_game_time() + mTrainMissionTime;
			break;
		case MISSION_PATROL:
...
bool
CFleet::create_as_empire_fleet(int aFleetRating, int aTechLevel, CAdmiral *aAdmiral, int aOrder)
{
	int
	...
	*(CShipDesign *)this = *PerfectShipDesign;
	...
	switch (get_size())
	{
		...
		case 5 :
		case 6 :
			mMaxShip = aAdmiral->get_fleet_commanding();
			set_current_ship(mMaxShip);
			break;

		case 7 :
			mMaxShip = (aAdmiral->get_fleet_commanding()) * 75 / 100;
			set_current_ship(mMaxShip);
			break;

		case 8 :
			mMaxShip = (aAdmiral->get_fleet_commanding()) * 66 / 100;
			set_current_ship(mMaxShip);
			break;

		case 9 :
			mMaxShip = (aAdmiral->get_fleet_commanding()) * 50 / 100;
			set_current_ship(mMaxShip);
			break;

		case 10 :
			mMaxShip = (aAdmiral->get_fleet_commanding()) * 20 / 100;
			set_current_ship(mMaxShip);
			break;
...
CFleetList::create_as_empire_fleet_group_static(CAdmiralList *aAdmiralList, int aFleetGroupType, int aPositionArg)
{
	...
	CapitalFleet->create_as_empire_fleet(CapitalFleetRating, CapitalFleetTechLevel, CapitalAdmiral, 0);
	...
	for (int i=2 ; i<=FleetGroupSize ; i++)
	{
		...
		CFleet *
			Fleet = new CFleet();
		Fleet->create_as_empire_fleet(FleetRating, TechLevel, Admiral, i-1);
...
bool
CFleetList::create_as_empire_fleet_group_volatile(CAdmiralList *aAdmiralList, int aFleetGroupType, int aPositionArg)
{
	int
		FleetGroupRating,
		TechLevel;
	...
	if (aFleetGroupType == CEmpire::EMPIRE_FLEET_GROUP_TYPE_MAGISTRATE)
	{
		...
		if (CapturedPlanet >= 0 && CapturedPlanet < (int)(CEmpire::mInitialNumberOfMagistratePlanet * (1/5)))
		{
			FleetGroupRating = 50 + 3*CapturedPlanet;
			TechLevel = 1;
		}
		else if (CapturedPlanet >= (int)(CEmpire::mInitialNumberOfMagistratePlanet * (1/5)) && CapturedPlanet < (int)(CEmpire::mInitialNumberOfMagistratePlanet * (2/5)))
		{
			FleetGroupRating = 20 + 3*CapturedPlanet;
			TechLevel = 2;
		}
		else if (CapturedPlanet >= (int)(CEmpire::mInitialNumberOfMagistratePlanet * (2/5)) && CapturedPlanet < (int)(CEmpire::mInitialNumberOfMagistratePlanet * (4/5)))
		{
			FleetGroupRating = 3*CapturedPlanet;
			TechLevel = 3;
		}
		else if (CapturedPlanet >= (int)(CEmpire::mInitialNumberOfMagistratePlanet * (4/5)) && CapturedPlanet < CEmpire::mInitialNumberOfMagistratePlanet)
		{
			FleetGroupRating = 2*CapturedPlanet;
			TechLevel = 4;
		}
		else
		{
	...
	else if (aFleetGroupType == CEmpire::EMPIRE_FLEET_GROUP_TYPE_MAGISTRATE_COUNTERATTACK)
	{
		...
		if (CapturedPlanet >= 0 && CapturedPlanet < (int)(CEmpire::mInitialNumberOfMagistratePlanet * (1/5)))
		{
			FleetGroupRating = (50 + 3*CapturedPlanet) + 30;
			TechLevel = 1;
		}
		else if (CapturedPlanet >= (int)(CEmpire::mInitialNumberOfMagistratePlanet * (1/5)) && CapturedPlanet < (int)(CEmpire::mInitialNumberOfMagistratePlanet * (2/5)))
		{
			FleetGroupRating = (20 + 3*CapturedPlanet) + 30;
			TechLevel = 2;
		}
		else if (CapturedPlanet >= (int)(CEmpire::mInitialNumberOfMagistratePlanet * (2/5)) && CapturedPlanet < (int)(CEmpire::mInitialNumberOfMagistratePlanet * (4/5)))
		{
			FleetGroupRating = (3*CapturedPlanet) + 30;
			TechLevel = 3;
		}
		else if (CapturedPlanet >= (int)(CEmpire::mInitialNumberOfMagistratePlanet * (4/5)) && CapturedPlanet < CEmpire::mInitialNumberOfMagistratePlanet)
		{
			FleetGroupRating = (2*CapturedPlanet) + 30;
			TechLevel = 4;
		}
		else
		{
	...
	else if (aFleetGroupType == CEmpire::EMPIRE_FLEET_GROUP_TYPE_EMPIRE_PLANET)
	{
		...
		if (CapturedPlanet >= 0 && CapturedPlanet < (int)(CEmpire::mInitialNumberOfEmpirePlanet * (10/50)))
		{
			FleetGroupRating = 100 + (int)(CapturedPlanet / 20);
			TechLevel = 5;
		}
		else if (CapturedPlanet >= (int)(CEmpire::mInitialNumberOfEmpirePlanet * (10/50)) && CapturedPlanet < (int)(CEmpire::mInitialNumberOfEmpirePlanet * (40/50)))
		{
			FleetGroupRating = 80 + (int)(CapturedPlanet / 100);
			TechLevel = 1 + dice(2, 2);
		}
		else if (CapturedPlanet >= (int)(CEmpire::mInitialNumberOfEmpirePlanet * (40/50)) && CapturedPlanet < (int)(CEmpire::mInitialNumberOfEmpirePlanet * (49/50)))
		{
			FleetGroupRating = 70 + (int)(CapturedPlanet / 50);
			TechLevel = 3 + number(2);
		}
		else if (CapturedPlanet >= (int)(CEmpire::mInitialNumberOfEmpirePlanet * (49/50)) && CapturedPlanet < CEmpire::mInitialNumberOfEmpirePlanet)
		{
	...
	{
		FleetGroupRating = 120 + dice(2, 40);
		TechLevel = 5;
	}
	else
	{
