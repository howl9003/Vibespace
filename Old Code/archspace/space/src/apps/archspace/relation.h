...
class CPlayerRelation: public CRelation
{
	...
	public:
		inline CPlayer* get_player1();
		inline CPlayer* get_player2();

	public:
		void set_player1_id(int aPlayerID);
		void set_player2_id(int aPlayerID);
		inline void set_player1(CPlayer *aPlayer);
		inline void set_player2(CPlayer *aPlayer);
...
class CCouncilRelation: public CRelation
{
	...
	public: // get
		inline CCouncil* get_council1();
		inline CCouncil* get_council2();

	public: // set
		void set_council1_id(int aCouncilID);
		void set_council2_id(int aCouncilID);
		inline void set_council1(CCouncil* aOwner);
		inline void set_council2(CCouncil* aTarget);
