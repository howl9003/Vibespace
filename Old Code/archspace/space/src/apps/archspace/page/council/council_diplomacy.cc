...
//	system_log("start page handler %s", get_name());
	...
	FootNote.format("<IMG SRC=\"http://%s/image/as_game/council/required1_icon.gif\" WIDTH=19 HEIGHT=16 ALIGN=ABSBOTTOM>\n&nbsp;&nbsp;&nbsp;&nbsp;",
					(char *)CGame::mImageServerURL);
	FootNote += GETTEXT("Not Required");
	FootNote.format("<IMG SRC=\"http://%s/image/as_game/council/notrequired1_icon.gif\" WIDTH=19 HEIGHT=16 ALIGN=ABSBOTTOM>\n</TD>\n</TR>\n</TABLE>\n",
					(char *)CGame::mImageServerURL);
