...
//	system_log( "start page handler %s", get_name());
	...
	if(Message->get_sender() == NULL)
	{
		...
		ITEM("LINK",
				(char *)format("<TR>\n<TD CLASS=\"maintext\" ALIGN=\"center\"><A HREF=read_diplomatic_message.as><IMG SRC=\"http://%s/image/as_game/bu_list_1.gif\" BORDER=0 WIDTH=\"37\" HEIGHT=\"11\"></A>\n</TR>", (char *)CGame::mImageServerURL));
	}
	else if (Message->get_sender()->get_game_id() == EMPIRE_GAME_ID)
	{
		ITEM("REPLY_TABLE", " ");
	...
	else
	{
		...
		ITEM("LINK",
				(char *)format("<TR>\n<TD CLASS=\"maintext\" ALIGN=\"center\"><INPUT TYPE=image SRC=\"http://%s/image/as_game/bu_send_1.gif\" BORDER=\"0\">&nbsp;<A HREF=read_diplomatic_message.as><IMG SRC=\"http://%s/image/as_game/bu_list_1.gif\" BORDER=0 WIDTH=\"37\" HEIGHT=\"11\"></A>\n</TR>", (char *)CGame::mImageServerURL, (char *)CGame::mImageServerURL));
	}
