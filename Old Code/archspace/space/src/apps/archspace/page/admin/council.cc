...
//	system_log("start page handler %s", get_name());
	...
	CouncilInfo.format("<INPUT TYPE=image SRC=\"http://%s/image/as_game/bu_change.gif\">\n",
	...
	CouncilInfo.format("<INPUT TYPE=image SRC=\"http://%s/image/as_game/bu_view.gif\">\n",
						(char *)CGame::mImageServerURL);
	CouncilInfo += "</FORM>\n";
	CouncilInfo += "</TD>\n";
	...
	for (int i=0 ; i<RelationList->length() ; i++)
	{
		...
		switch (Relation->get_relation())
		{
			case CRelation::RELATION_TOTAL_WAR :
			{
				...
				TotalWarCouncil.format("<INPUT TYPE=image SRC=\"http://%s/image/as_game/bu_view.gif\">\n",
										(char *)CGame::mImageServerURL);
			...
			case CRelation::RELATION_WAR :
			{
				...
				WarCouncil.format("<INPUT TYPE=hidden NAME=COUNCIL_ID VALUE=%d>\n",
									TargetCouncil->get_id());
				WarCouncil.format("<INPUT TYPE=image SRC=\"http://%s/image/as_game/bu_view.gif\">\n",
									(char *)CGame::mImageServerURL);
				WarCouncil += "</FORM>\n";
			}
				break;
			...
			case CRelation::RELATION_TRUCE :
			{
				...
				TruceCouncil.format("<INPUT TYPE=hidden NAME=COUNCIL_ID VALUE=%d>\n",
										TargetCouncil->get_id());
				TruceCouncil.format("<INPUT TYPE=image SRC=\"http://%s/image/as_game/bu_view.gif\">\n",
									(char *)CGame::mImageServerURL);
				TruceCouncil += "</FORM>\n";
			}
				break;
			...
			case CRelation::RELATION_PEACE :
			{
				...
				PeaceCouncil.format("<INPUT TYPE=hidden NAME=COUNCIL_ID VALUE=%d>\n",
										TargetCouncil->get_id());
				PeaceCouncil.format("<INPUT TYPE=image SRC=\"http://%s/image/as_game/bu_view.gif\">\n",
									(char *)CGame::mImageServerURL);
				PeaceCouncil += "</FORM>\n";
			}
				break;
			...
			case CRelation::RELATION_ALLY :
			{
				...
				AllyCouncil.format("<INPUT TYPE=hidden NAME=COUNCIL_ID VALUE=%d>\n",
										TargetCouncil->get_id());
				AllyCouncil.format("<INPUT TYPE=image SRC=\"http://%s/image/as_game/bu_view.gif\">\n",
									(char *)CGame::mImageServerURL);
				AllyCouncil += "</FORM>\n";
			}
				break;
			...
			case CRelation::RELATION_SUBORDINARY :
			{
				...
				if (Relation->get_council1()->get_id() == Council->get_id())
				{
					...
					SubordinaryCouncil.format("<INPUT TYPE=hidden NAME=COUNCIL_ID VALUE=%d>\n",
												TargetCouncil->get_id());
					SubordinaryCouncil.format("<INPUT TYPE=image SRC=\"http://%s/image/as_game/bu_view.gif\">\n",
												(char *)CGame::mImageServerURL);
				...
				else
				{
					...
					SupremacyCouncil.format("<INPUT TYPE=hidden NAME=COUNCIL_ID VALUE=%d>\n",
												TargetCouncil->get_id());
					SupremacyCouncil.format("<INPUT TYPE=image SRC=\"http://%s/image/as_game/bu_view.gif\">\n",
											(char *)CGame::mImageServerURL);
