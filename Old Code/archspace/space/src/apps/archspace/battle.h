...
class CTargetFleet: public CBase
{
	public:
		CTargetFleet();
...
class CBattleFleet : public CVector 
{
	...
	public:
		...
		void reset_detected() { mIsDetected = false; }
		...
		int get_morale() { return mMorale; }
		int change_morale( int aMorale );
...
class CBattleFleetList:public CSortedList
{
	...
	public:
		...
		void update_morale(int aMoraleUp, int aCapitalMorale, int aFleetMorale);
