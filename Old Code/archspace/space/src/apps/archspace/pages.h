...
/**
*/
class CPagePlayerAdmissionAccuse: public CPageCouncilLink
{
	public: 
		CPagePlayerAdmissionAccuse():CPageCouncilLink() {}
...
/**
*/
class CPageCouncilDiplomaticMessageAccuse: public CPageCouncilLink
{
	public: 
		CPageCouncilDiplomaticMessageAccuse():CPageCouncilLink() {}
...
/**
*/
class CPageDiplomaticMessage: public CPageCouncilLink
{   
    public: 
        CPageDiplomaticMessage():CPageCouncilLink() {}
...
//		virtual int access_level() = 0;
	...
	public:
		static CPortalUserData mPortal;
