<?php
// $Horde: chora/config/mime_drivers.php.dist,v 1.1.2.3 2002/10/02 16:18:20 jan Exp $

/**
 * Decide which output drivers you want to activate for
 * the Chora module.
 * Right now, the choices are:
 *
 * text: Perform URL syntax highlighting on text portions
 */

$mime_drivers_map['chora']['registered'] = array('text');
...
$mime_drivers_map['chora']['overrides'] = array('images');
...
$mime_drivers['chora']['default']['icons'] = array(
        'default' => 'text.gif' );
...
$mime_drivers['chora']['text']['handles'] = array(
        'text/plain', 'text/css');
