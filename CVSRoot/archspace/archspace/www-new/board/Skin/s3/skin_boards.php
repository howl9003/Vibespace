...
<br />
	<div class="tableborder">
	  <table width="100%" border="0" cellspacing="1" cellpadding="4">
	  <tr> 
		<td align="center" nowrap="nowrap" class='titlemedium'><img src="{$ibforums->vars['img_url']}/spacer.gif" alt="" width="28" height="1" /></td>
		...
		<th align='left' width="27%" nowrap="nowrap" class='titlemedium'>{$ibforums->lang['last_post_info']}</th>
	  </tr>
EOF;
}
