...
function quick_reply_box_open($fid="",$tid="",$show="hide") {
global $ibforums;
return <<<EOF
<script type="text/javascript">
	...
	<div align='left' id='qr_open' style="display:$show;position:relative;">
	   <form name='REPLIER' action="{$ibforums->base_url}act=Post&amp;CODE=03&amp;f=$fid&amp;t=$tid&amp;st={$ibforums->input['st']}" method='post'>
	   ...
	   <div class="tableborder">
		 ...
		 <div class="tablepad" align="center">
			 <textarea cols='70' rows='8' name='Post' onmouseover="this.focus();" class='textinput' tabindex="1"></textarea>
			 <br /><br />
...
<a name='top'></a>
<!--IBF.FORUM_RULES-->
<div align='left' class="pagelinks"><br />{$data['TOPIC']['SHOW_PAGES']}&nbsp;{$data['TOPIC']['go_new']}</div>
<div align='right'>{$data[TOPIC][REPLY_BUTTON]}<a href='{$ibforums->base_url}act=Post&amp;CODE=00&amp;f={$data[FORUM]['id']}' title='{$ibforums->lang['start_new_topic']}'><{A_POST}></a>{$data[TOPIC][POLL_BUTTON]}</div>
<br />
<div class="tableborder">
...
<!--Begin Msg Number {$post['pid']}-->
    ...
    <tr>
      <td valign='middle' class='row4' width="1%"><a name='entry{$post['pid']}'></a><span class='{$post['name_css']}'>{$author['name']}</span></td>
        ...
        {$post['post_icon']}<span class='postdetails'><b>{$ibforums->lang['posted_on']}</b> {$post['post_date']}</span>
        </div>
...
<br />
<div align='left' class="pagelinks"><!--IBF.TOPIC_OPTIONS_CLOSED-->{$data[TOPIC][SHOW_PAGES]}</div>
<div align='right'>{$data[TOPIC][REPLY_BUTTON]}<!--IBF.QUICK_REPLY_CLOSED--><a href='{$ibforums->base_url}act=Post&amp;CODE=00&amp;f={$data[FORUM]['id']}' title='{$ibforums->lang['start_new_topic']}'><{A_POST}></a>{$data[TOPIC][POLL_BUTTON]}</div>
