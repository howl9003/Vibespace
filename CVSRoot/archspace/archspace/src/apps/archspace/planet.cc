	...
	CPlanet::calc_commerce()
{
	...
	// Diplomacy Modifier to Commerce
    ...
    } else if (DiplomacyMultiplier > 100) {
        DiplomacyMultiplier = 100;
    }    
    
    ProductPoint = (int) ((((double) 100 - (double) DiplomacyMultiplier)/(double) 100) * (double) ProductPoint);
