...
//		TreeFields.format(ins_doc, GETTEXT("Bounties"), "/archspace/empire/bounty.as");
	...
	//TreeFields.format(ins_fld, GETTEXT("SPECIAL EVENTS"), "/archspace/special/special_events.as");
	//TreeFields.format(ins_doc, GETTEXT("Summary"), "/archspace/special/event_summary.as");
...
//        if (CONFIG->get_string("Game", "IRCPHPScript", NULL) != NULL)
	...
	TreeFields.format(ins_doc, GETTEXT("Archspace Wiki"), "http://www.katserv.info/aswiki/index.php?title=Main_Page");
	...
	TreeFields.format(ins_doc_window, GETTEXT("Donate"), "http://archspace.org/donate.html");
