<?php
/* $Id: config.inc.php,v 1.4 2004/05/13 14:11:32 brian Exp $ */
...
$cfg['Servers'][$i]['user']          = 'space';      // MySQL user
$cfg['Servers'][$i]['password']      = 'comconq1';          // MySQL password (only needed
