<?php
/* $Id: sqlvalidator.class.php,v 1.4 2004/05/13 14:11:34 brian Exp $ */
...
* $Source: /var/cvsroot/archspace/www/Ad/phpMyAdmin-2.5.5-pl1/libraries/sqlvalidator.class.php,v $
*
...
*
* @version  $Id: sqlvalidator.class.php,v 1.4 2004/05/13 14:11:34 brian Exp $
*/
...
if (!function_exists('class_exists') || !class_exists('SOAP_Client')) {
    ...
    $use_array = array("a_sessionId" => $session->sessionId, "a_sessionKey" => $session->sessionKey, "a_SQL" => $sql, "a_resultType" => $this->output_type);
        ...
        function PMA_SQLValidator()
        {
            ...
            $this->calling_program_version       = '$Revision: 1.4 $';
