...
***********************************/
  check = new Image();
  check.src = "/image/as_game/domestic/planet_check.gif";
  
  box = new Image();
  box.src = "/image/as_game/domestic/planet_box.gif";
  
  lock = new Image();
  lock.src = "/image/as_game/domestic/lock.gif";
  
  unlock = new Image();
  unlock.src = "/image/as_game/domestic/unlock.gif";
  ...
  {
    document.form1.factory.value = index;
    if(index == 0)
    {
  ...
  {
    document.form1.laboratory.value = index;
    if(index == 0)
    {
  ...
  {
    document.form1.military.value = index;
    if(index == 0)
    {
