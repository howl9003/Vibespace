...
*/
	ITEM("LEASER_S_OFFICE_MESSAGE",
			GETTEXT("This office is the domain of the servants of the Empire. Here is where the Empire auctions off extra planets. You may only bid on planets of your own race. In order to make sure no single person can surpass the Empire in power, the amount you bid is the amount that each of your current planets will pay. This means, if you bid 1 million PP and have ten planets, you will pay 10 million PP. Take Care and Good Shopping."));
