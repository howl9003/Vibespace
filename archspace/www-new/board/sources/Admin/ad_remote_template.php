...
class ad_settings {
	...
	function css_preview()
	{
		...
		$DB->query("SELECT css_text, css_name FROM acf_css WHERE cssid='".$IN['id']."'");
		...
		$DB->query("SELECT img_dir FROM acf_skins WHERE css_id='".$IN['id']."'");
	...
	function print_css_searchlinks()
	{
		...
		$DB->query("SELECT set_id FROM acf_skins WHERE css_id='".$IN['id']."'");
		...
		//die("SELECT suid, set_id, group_name, func_name FROM acf_skin_templates WHERE set_id='".$set['tmpl_id']."' AND section_content LIKE '%".$like."%' ORDER BY group_name");
		
		$DB->query("SELECT suid, set_id, group_name, func_name FROM acf_skin_templates WHERE set_id='".$set['set_id']."' AND section_content LIKE '%".$like."%' ORDER BY group_name");
	...
	function print_searchlinks()
	{
		...
		$DB->query("SELECT set_id FROM acf_skin_templates WHERE suid='".$IN['suid']."'");
		
		$set = $DB->fetch_row();
		
		$DB->query("SELECT suid, set_id, group_name, func_name FROM acf_skin_templates WHERE set_id='".$set['set_id']."' AND section_content LIKE '%$search_text%' ORDER BY group_name");
	...
	function print_compare_new()
	{
		...
		$DB->query("SELECT * FROM acf_skin_templates WHERE suid='".$IN['suid']."'");
		...
		$DB->query("SELECT css_id, img_dir FROM acf_skins WHERE set_id='".$template['set_id']."'");
		$r = $DB->fetch_row();
		
		$DB->query("SELECT css_text FROM acf_css WHERE cssid='".$r['css_id']."'");
	...
	function macro_two()
	{
		...
		if ($extra != "")
		{
			...
			else if ($extra == 'lang')
			{
				...
				$DB->query("SELECT group_name FROM acf_skin_templates WHERE suid='{$IN['suid']}'");
		...
		else
		{
			...
			$DB->query("SELECT macro_id FROM acf_skins WHERE set_id='".$template['set_id']."'");
			
			$macrod = $DB->fetch_row();
			
			$DB->query("SELECT macro_value, macro_replace FROM acf_macro WHERE macro_set='".$macrod['macro_id']."' AND macro_value='$macro'");
	...
	function do_preview()
	{
		...
		$DB->query("SELECT macro_value, macro_replace FROM acf_macro WHERE macro_set='".$macrod['macro_id']."'");
