...
class ad_mysql {
	...
	function show_backup_form()
	{
		...
		$ADMIN->html .= $SKIN->add_td_row( array( 
													"<b>Skip non essential data?</b><br>Will not produce insert rows for acf_sessions, acf_admin_sessions, acf_search_results, acf_reg_anti_spam.",
