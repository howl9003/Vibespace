...
<!--IBF.SUBFORUMS-->
<!--IBF.MODLINK-->
<div align='left' class="pagelinks"><br />{$data['SHOW_PAGES']}</div>
<div align='right'><a href='{$ibforums->base_url}act=Post&amp;CODE=00&amp;f={$data['id']}'><{A_POST}></a>{$data[POLL_BUTTON]}</div>
...
<div align='left' class="pagelinks">{$data[SHOW_PAGES]}</div>
<div align='right'><a href='{$ibforums->base_url}act=Post&amp;CODE=00&amp;f={$data['id']}'><{A_POST}></a>{$data[POLL_BUTTON]}</div>
