...
<tr>
   ...
   <td valign='middle'><select name='dateline' class='forminput'><option value='1'>1</option><option value='7'>7</option><option value='30' selected>30</option><option value='90'>90</option><option value='365'>365</option><option value='all'>{$ibforums->lang['arc_alldays']}</option></select>&nbsp;&nbsp;{$ibforums->lang['arc_days']}</td>
</tr>
<tr>
...
<tr>
   ...
   <td valign='middle'><select name='delete' class='forminput'><option value='yes' selected>{$ibforums->lang['arc_yes']}</option><option value='no'>{$ibforums->lang['arc_no']}</option></select></td>
</tr>
<tr>
...
<div class="tableborder">
 ...
 <table width='100%' cellpadding='3' cellspacing='1'>
  <tr>
      <td valign='middle' class='row4'><span class='normalname'>{$data['member']['name']}</span></td>
