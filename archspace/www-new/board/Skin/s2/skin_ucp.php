...
function photo_page($cur_photo, $cur_type, $url_photo, $show_size) {
global $ibforums;
return <<<EOF
...
<form action="{$ibforums->base_url}" enctype='multipart/form-data' method="post" name="bob" onsubmit="return checkform();">
...
function avatar_main($data, $formextra="", $hidden_field="") {
global $ibforums;
return <<<EOF
...
<form action='{$ibforums->base_url}' method='post' $formextra name='creator' onsubmit="return checkform();">
<input type='hidden' name='act' value='UserCP' />
...
function avatar_gallery_start_table($title="", $av_gals="", $current_folder) {
global $ibforums;
return <<<EOF
...
<form action="{$ibforums->base_url}" method="post" name='theForm' onsubmit='return ValidateProfile()'>
<input type='hidden' name='act' value='UserCP' />
...
<form action="{$ibforums->base_url}" method="post" name='prefs'>
<input type='hidden' name='act' value='UserCP' />
