<?php
/* $Id: czech-utf-8.inc.php,v 1.1.1.1 2004/12/25 09:14:36 brian Exp $ */
...
$strIndexWarningPrimary = 'Sloupec `%s` by neměl být zárověň obsažen v&nbsp;PRIMARY a INDEX klíči';
$strIndexWarningTable = 'Problémy s&nbsp;indexy v&nbsp;tabulce `%s`';
$strIndexWarningUnique = 'Sloupec `%s` by neměl být zárověň obsažen v&nbsp;PRIMARY a UNIQUE klíči';
$strIndexes = 'Indexy';
