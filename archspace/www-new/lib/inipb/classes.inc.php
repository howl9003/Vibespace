...
/**
 * Clone of IPB's parser class used in SDK modules if IPB SDK run itself inside IPB.

 * @author Matt Mecham (mainly), Cow
 * @copyright (c) 2001 - 2003 Invision Power Services, where indicated.
 * @ignore
 */
class SDK_post_parser {
	...
	function post_parser($load=0)
	{
		...
		if ($load != 0)
		{
			...
			$DB->query("SELECT typed, image from acf_emoticons");
