...
/***************************************************************************
    ...
    $Id: auth.php,v 1.45 2001/02/09 19:47:33 thefinn Exp $
...
if(@fopen("config.$phpEx", "a")) {
	?>
	The config file is writable by the webserver. This is a major security risk 
	...
	Switch on the readonly attribute if you are running the script on a Windows machine.<br>
	<?php
	exit();
	}
