...
/***************************************************************************
    ...
    $Id: reply.php,v 1.65 2001/02/09 07:30:57 thefinn Exp $
...
if($submit) {
   ...
   $sql = "INSERT INTO posts (topic_id, forum_id, poster_id, post_text, post_time, poster_ip) VALUES ('$topic', '$forum', '$userdata[user_id]', '$message', '$time', '$poster_ip')";
   if(!$result = mysql_query($sql, $db)) {
