...
/***************************************************************************
    ...
    copyright            : (C) 2000 James Atkinson
    email                : james@totalgeek.org

    $Id: faq.php,v 1.11 2001/02/09 13:36:16 bartvb Exp $
...
<P>
	...
	echo "<TD><font face=\"<?php echo $FontFace?>\" size=\"2\" color=\"ffffff\">$m[rank_title]</font></TD>";
	echo "<TD><font face=\"<?php echo $FontFace?>\" size=\"2\" color=\"ffffff\">$m[rank_min]</font></TD>";
	echo "<TD><font face=\"<?php echo $FontFace?>\" size=\"2\" color=\"ffffff\">$m[rank_max]</font></TD>";
