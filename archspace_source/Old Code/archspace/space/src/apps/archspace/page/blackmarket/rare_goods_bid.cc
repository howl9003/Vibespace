...
bool
CPageBlackMarketRareGoodsBid::handler(CPlayer *aPlayer)
{
	...
	if( aPlayer->get_purchased_project_list()->get_by_id( bid->get_item() ) )
	{
	...
	ITEM( "PROJECT_ITEM_ID", bid->get_id() );
	...
	return output("black_market/rare_goods_bid.html");
}
