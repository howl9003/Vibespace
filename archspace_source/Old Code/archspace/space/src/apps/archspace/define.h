...
#define PERIOD_CREATE_ADMIRAL			24
#define ADMIRAL_MILITARY_BONUS			4
...
#define SECRET_PROJECT_TABLE \
			(((CArchspace*)gApplication)->game()->secret_project_table())
#define ENDING_PROJECT_TABLE \
			(((CArchspace*)gApplication)->game()->ending_project_table())
#define PERSONAL_ENDING_TABLE \
			(((CArchspace*)gApplication)->game()->personal_ending_table())
...
#define PLAYER_ATTACK_RESTRICTION_POWER_MIN		80

#define COUNCIL_ATTACK_RESTRICTION_POWER_MAX	400
#define COUNCIL_ATTACK_RESTRICTION_POWER_MIN	80
