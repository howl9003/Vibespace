...
/**
*/
class CFleetEffect : public CBase
{
	public :
		CFleetEffect();
...
class CComponent: public CBase
{
	...
	public:
		...
		void set_prerequisite(int aPrerequisite) { mPrerequisite = aPrerequisite; }
...
/**
*/
class CComponentScript: public CScript
{
	public:
