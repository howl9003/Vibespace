...
class CAdmission: public CStore
{
	...
	public:
		inline void set_player(CPlayer* aPlayer);
		inline void set_council(CCouncil* aCouncil);
...
class CCouncil: public CStore
{
	...
	public: // set
		...
		inline void change_production(int aProduction);
	...
	public: // etc
		...
		inline void add_relation(CCouncilRelation* aRelation);
		...
		inline CCouncil *relation_council(int aCouncilID);

		inline void add_council_message(CCouncilMessage *aMessage);
		inline CCouncilMessage *get_council_message(int aMessageID);
...
//		const char* try_council_fusion(aCouncil);
		...
		inline CCouncil* get_supremacy_council();
		inline void set_supremacy_council(CCouncil* aCouncil);
