...
class CTech: public CBase
{
	...
	public: // set
		...
		inline void set_prerequisite(
						int aPrerequisite1, int aPrerequisite2 = 0);
		inline void set_project(int aProjectID);
		void set_spy(int aSpyID) { mSpy = aSpyID; }
...
inline int 
CTech::get_prerequisite1() 
{ 
	return mPrerequisite1; 
}

inline int 
CTech::get_prerequisite2() 
{ 
	return mPrerequisite2;
}
...
inline void 
CTech::set_prerequisite(int aPrerequisite1, int aPrerequisite2)
{
	mPrerequisite1 = aPrerequisite1;
	mPrerequisite2 = aPrerequisite2;
}
...
class CKnownTechList: public CSortedList, public CStore
{
	...
	public:
		...
		const char *table() { return "tech"; }
		CString &query();

		CCommandSet& get_information() { return mInfo; }
		CCommandSet& get_life() { return mLife; }
		CCommandSet& get_matter_energy() { return mMatter; }
		CCommandSet& get_social() { return mSocial; }
