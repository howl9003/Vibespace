...
//------------------------------------------------ CAction
#define PERIOD_PLAYER_COUNCIL_DONATION 		4*24 // turn
#define PERIOD_PLAYER_BREAK_PACT			4*72 // turn
#define PERIOD_PLAYER_BREAK_ALLY			4*72 // turn
#define PERIOD_COUNCIL_DECLARE_TOTAL_WAR	4*24 // turn
#define PERIOD_COUNCIL_DECLARE_WAR			4*24 // turn
#define PERIOD_COUNCIL_BREAK_PACT			4*72 // turn
#define PERIOD_COUNCIL_BREAK_ALLY			4*72 // turn
#define PERIOD_COUNCIL_IMPROVE_RELATION		4*72 // turn
#define PERIOD_COUNCIL_MERGING_OFFER		24*60*60 // second
