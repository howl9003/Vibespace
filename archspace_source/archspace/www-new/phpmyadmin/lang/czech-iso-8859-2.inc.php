<?php
/* $Id: czech-iso-8859-2.inc.php,v 1.1.1.1 2004/12/25 09:14:36 brian Exp $ */
...
$strError = 'Chyba';
$strEscapeWildcards = 'Zástupné znaky _ a % by mìly být eshould be escapovány pomocí \, pokud je chcete pou¾ít jako znak';
...
$strIndexWarningPrimary = 'Sloupec `%s` by nemìl být zárovìò obsa¾en v&nbsp;PRIMARY a INDEX klíèi';
$strIndexWarningTable = 'Problémy s&nbsp;indexy v&nbsp;tabulce `%s`';
$strIndexWarningUnique = 'Sloupec `%s` by nemìl být zárovìò obsa¾en v&nbsp;PRIMARY a UNIQUE klíèi';
$strIndexes = 'Indexy';
