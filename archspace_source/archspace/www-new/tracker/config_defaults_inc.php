<?php
	...
	# --------------------------------------------------------
	# $Id: config_defaults_inc.php,v 1.1.1.1 2004/12/25 09:14:39 brian Exp $
	# --------------------------------------------------------
	...
	$g_cvs_web				= 'http://as.kenisware.org/CVS/';
	...
	$g_cookie_path			= '/tracker/';
	$g_cookie_domain		= '68.11.248.40';
	#$g_cookie_domain		= '';
