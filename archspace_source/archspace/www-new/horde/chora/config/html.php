<?php
/* 
 * $Horde: chora/config/html.php.dist,v 1.15.2.2 2002/03/20 20:30:06 chuck Exp $
 *
 * CSS properties unique to Chora.
 * This file is parsed by css.php, and used to produce a stylesheet.
 */

$css['body']['font-family'] = 'Geneva,Arial,Helvetica,sans-serif';
$css['body']['font-size'] = '11px';
...
$css['.title']['font-size'] = '15px';
$css['.title']['font-weight'] = 'bold';

$css['.outline-lite']['background-color'] = '#cdcdcd';
$css['.outline-menu']['background-color'] = '#9999cc';

$css['.menufoot']['color'] = '#222222';
$css['.menufoot']['background-color'] = '#dfdfdf';
$css['.menufoot']['font-family'] = 'Geneva,Arial,Helvetica,sans-serif';

$css['a.smallheader']['color'] = 'white';
$css['a.smallheader']['font-size'] = '11px';
$css['a.smallheader:hover']['color'] = '#ddddff';

$css['td']['font-size'] = '11px';

$css['th']['font-size'] = '11px';

$css['.directory']['background-color'] = '#dedeee';
$css['.directory']['color'] = 'black';
$css['.info']['background-color'] = '#d0d0d0';

$css['.item0']['background-color'] = '#eeeeee';
$css['.item1']['background-color'] = '#ffffff';
$css['.item2']['background-color'] = '#f4f4f4';
$css['.attic']['background-color'] = '#eedddd';
$css['.attic']['font-style'] = 'italic';

$css['.footer']['color'] = '#aaaacc';

$css['.diff-back']['background-color'] = '#ffffff';
$css['.diff-header']['background-color'] = '#cfcfd9';
$css['.diff-selected']['background-color'] = '#e0daaa';
...
$css['.checkout']['background-color'] = '#fafafa';
