...
class Help {
    ...
    function Help() {
 	...
 	function show_titles() {
 		...
 		$DB->query("SELECT id, title, description from acf_faq ORDER BY title ASC");
 	...
 	function show_section() {
 		...
 		$DB->query("SELECT id, title, text from acf_faq WHERE ID='$id'");
 		$topic = $DB->fetch_row();
 	...
 	function do_search() {
 		...
 		$DB->query("SELECT id, title, description from acf_faq WHERE LOWER(title) LIKE '%$search_string%' or LOWER(text) LIKE '%$search_string%' ORDER BY title ASC");
