...
class CDefensePlan: public CStore
{
	...
	public:
		...
		enum EEnemyRace
		{
			...
			RACE_XERUSIAN = 256,
			RACE_XESPERADOS= 512,
			RACE_TRABOTULIN = 1024,	// CVS-merge: 11th race
			RACE_ALL = RACE_HUMAN | RACE_TARGOID | RACE_BUCKANEER | RACE_TECANOID | RACE_EVINTOS | RACE_AGERUS | RACE_BOSALIAN | RACE_XELOSS | RACE_XERUSIAN | RACE_XESPERADOS | RACE_TRABOTULIN
		};
