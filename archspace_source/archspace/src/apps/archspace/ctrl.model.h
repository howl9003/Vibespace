...
enum EAbility {
	...
	// --- CVS-merge: new race/player abilities (appended; battle/economy hooks for
	// the non-flavor ones are ported with the S2/S4 content that grants them.
	// Temporal Mastery is flavor-only -- it parses but has no mechanical effect) ---
