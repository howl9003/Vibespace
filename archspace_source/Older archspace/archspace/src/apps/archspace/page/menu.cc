...
// Generics
	...
	char *ins_doc_chat = "insDoc(aux1, gLnk(\"R\", \"%s\", \"%s%s\"))\n";	
...
//        if (CONFIG->get_string("Game", "IRCPHPScript", NULL) != NULL)
	...
	TreeFields.format(ins_fld, GETTEXT("FORUM"), (char *)CGame::mForumServerURL);
		TreeFields.format(ins_doc, GETTEXT("Council Forum"), "/CouncilForum/index.php3");
	TreeFields.format(ins_fld, GETTEXT("HELP"), "");
		TreeFields.format(ins_doc_window, GETTEXT("General Chat"), "/nirc/");
...
//		TreeFields.format(ins_doc_window, GETTEXT("Donate"), "https://www.paypal.com/xclick/business=zbyte8%40yahoo.com&item_name=www.archspace.org&no_shipping=0&no_note=1&tax=0&currency_code=USD");
