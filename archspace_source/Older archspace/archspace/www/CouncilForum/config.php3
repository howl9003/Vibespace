<?php
// added by thedaz
$as_url = "http://archspace.68.11.248.40";
...
$url_phpbb = "http://archspace.68.11.248.40/CouncilForum"; 
...
$folder_image = "http://board.68.11.248.40/ASubbKR/closed.gif";
$hot_folder_image = "$url_images/hot_folder.gif";
//$hot_folder_image = "http://board.68.11.248.40/ASubbKR/hotclosed.gif";
//$newposts_image = "$url_images/red_folder.gif";
$newposts_image = "http://board.68.11.248.40/ASubbKR/closedb.gif";
//$hot_newposts_image = "$url_images/hot_red_folder.gif";
$hot_newposts_image = "http://board.68.11.248.40/ASubbKR/hotclosedb.gif";
...
/* -- Added Images -- */
$FORUM_TITLE_IMAGE = "http://board.68.11.248.40/ASubbKR/images/forum_title.gif";
$NEW_TOPIC_IMAGE = "http://board.68.11.248.40/ASubbKR/images/newtopic.gif";
$SEARCH_IMAGE = "http://board.68.11.248.40/ASubbKR/images/search.gif";
$REPLY_IMAGE = "http://board.68.11.248.40/ASubbKR/images/reply.gif";
$GO_IMAGE = "http://board.68.11.248.40/ASubbKR/images/go.gif";
?>
