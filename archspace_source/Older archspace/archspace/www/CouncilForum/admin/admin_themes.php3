<?php
   ...
   * 
   *     $Id: admin_themes.php3,v 1.3 2004/05/13 14:11:34 brian Exp $
   * 
   *  ***************************************************************************/
...
?>
	   ...
	   <TR BGCOLOR="<?php echo $color1?>" ALIGN="LEFT">
	   <TD ALIGN="CENTER" COLSPAN="3"><FONT FACE="<?php echo $FontFace?>" SIZE="<?php echo $FontSize2?>" COLOR="<?php echo $textcolor?>">Click <a href="<?php echo $PHP_SELF?>">here</a> to return to the Theme Administration panel. Or click <a href="<?php echo $url_admin?>">here</a> to return to the admin panel.</FONT></TD>
	   </TR>
	   </TABLE></TABLE>
<?php
