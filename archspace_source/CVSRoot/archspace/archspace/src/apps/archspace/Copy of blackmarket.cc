...
#undef MIND_TRACKER
	...
	int base[MAX_SHIP_CLASS] = { 5, 4, 3, 3, 2, 2, 1, 1, 1, 1, 1, 1 };
	int baseDice[MAX_SHIP_CLASS] = { 4, 4, 3, 2, 3, 3, 2, 2, 0, 0, 0, 0 };
	int dayDice[MAX_SHIP_CLASS] = { 5, 5, 4, 2, 2, 2, 3, 2, 2, 1, 1, 1 };
	int dayRoll[MAX_SHIP_CLASS] = { 2, 2, 2, 2, 2, 2, 3, 3, 3, 4, 3, 2 };
...
CBlackMarket::bid(int aBidID, int aPlayerID, int price)
{
	...
	{
		winner->change_reserved_production( -price * (winner->get_planet_list()->length() + BLACK_MARKET_PLANET_COUNT_OFFSET));
		bid->set_number_of_planet(winner->get_planet_list()->length() + BLACK_MARKET_PLANET_COUNT_OFFSET);
	}
