<?php
/* $Id: sqlvalidator.class.php,v 1.1.1.1 2004/12/25 09:14:37 brian Exp $ */
...
* $Source: /var/cvsroot/archspace/www-new/phpmyadmin/libraries/sqlvalidator.class.php,v $
*
...
*
* @version  $Id: sqlvalidator.class.php,v 1.1.1.1 2004/12/25 09:14:37 brian Exp $
*/
...
if (!function_exists('class_exists') || !class_exists('SOAP_Client')) {
    ...
    $use_array = array("a_sessionId" => $session->sessionId, "a_sessionKey" => $session->sessionKey, "a_SQL" => $sql, "a_resultType" => $this->output_type);
        ...
        function PMA_SQLValidator()
        {
            ...
            $this->calling_program_version       = '$Revision: 1.1.1.1 $';
